...
class CharacterMotorMovement {
	...
	//if (Input.GetKeyDown(shift))s=20;
	//else s=10;
...
function Update () {
	if (!useFixedUpdate)
		...
		var script = go.GetComponent(HeadbobScript);
		
		
		if(Input.GetAxis("Fire") && cansprint){
			movement.maxForwardSpeed = 20;
			movement.maxSidewaysSpeed = 20;
			sprinting = true;
			script.bobbingSpeed = 14;
		}else{
			movement.maxForwardSpeed = 10;
			movement.maxSidewaysSpeed = 10;
			sprinting = false;
			script.bobbingSpeed = 10;
		}
}
